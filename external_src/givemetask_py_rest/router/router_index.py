...
from flask import abort, make_response, request, current_app, jsonify
from functools import update_wrapper
from data_controller.schems import article_log

def apply(app):
    # you should routers in here

    @app.route('/searchLog/<user_id>/<doc_id>/<task_title>', methods=['POST'])
